...
Em linhas gerais, **Conda** seria a escolha mais indicada do que **PIP**, enquando o uso do **Docker** seria para projetos muito mais robustos. Portanto, para porjetos que preevem manutenção eficaz e aprendizado contínuio, **Conda** é recomendado. Aqui estão os principais motivos:
